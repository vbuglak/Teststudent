...
public class Deleteform extends javax.swing.JFrame {
    ...
    String fiostr,typeofstudyingstr,registrstr,groupstr;
        ...
        try {
             ...
             stmt.executeUpdate("DELETE FROM student.student WHERE idstudent='"+jTextField1.getText()+"'");
        }
        ...
        jOptionPane1.showMessageDialog(null,"Запись успешно удалена","Уведомление",jOptionPane1.PLAIN_MESSAGE);
